...
const Classifier: React.FC<params> = (props) => {
    ...
    const saveImage = () => {
        saveAs(props.imageSrc, `test.${props.imageFormat.split('/')[1]}`);
    }
    ...
    return (
        <HomeContainer>
                <LeftContent>
                    <FeedCapture imageSrc={props.imageSrc} imageFormat={props.imageFormat} setImageFormat={props.setImageFormat} />
                    <Results/>
                </LeftContent>
                <RightContent>

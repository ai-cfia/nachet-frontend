...
const Home = () => {
    ...
    return (
        <HomeContainer>
            <Classifier captureEmpty={captureEmpty} setCaptureEmpty={setCaptureEmpty} imageSrc={imageSrc} setImageSrc={setImageSrc} webcamRef={webcamRef} imageFormat={imageFormat} setImageFormat={setImageFormat}/>
        </HomeContainer>
    );
}
